// 한국 행정구역 데이터 (2024년 12월 기준)
export const KOREA_ADMINISTRATIVE_DISTRICT = {
  "서울특별시": [
...
// 시/도 목록 추출
export const CITY_PROVINCES = Object.keys(KOREA_ADMINISTRATIVE_DISTRICT);
...
// 시/도명 유효성 검증
export function isValidCityProvince(cityProvince: string): boolean {
  return cityProvince in KOREA_ADMINISTRATIVE_DISTRICT;
}

// 구/군명 유효성 검증
export function isValidDistrict(cityProvince: string, district: string): boolean {
