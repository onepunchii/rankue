...
export const CLUBS: Readonly<Record<ClubId, Club>> = {
    D: { id: "D", ballSpeed: 76.5, launchDeg: 10.9, spinRpm: 2686, spinLoftDeg: 12, ...wood, kGearDegPerCm: 4.5, gearLaunchDegPerCm: 1.0, faceMaxDeg: 5.0, faceUpCm: 2.8, faceDownCm: 2.8, kVertRpmPerCm: 600, kVertLaunchPerCm: 1.0, kVertSpeed: 0.006, zoneCoef: 0.70, sweepMs: 1120, carryPgaM: 275 * YD },
    "3W": { id: "3W", ballSpeed: 158 * MPH, launchDeg: 9.2, spinRpm: 3655, spinLoftDeg: 15, ...wood, kGearDegPerCm: 3.0, faceMaxDeg: 4.5, faceUpCm: 1.9, faceDownCm: 1.9, kVertRpmPerCm: 350, kVertLaunchPerCm: 0.7, kVertSpeed: 0.007, zoneCoef: 0.76, sweepMs: 1170, carryPgaM: 243 * YD },
    "5W": { id: "5W", ballSpeed: 152 * MPH, launchDeg: 9.4, spinRpm: 4350, spinLoftDeg: 17, ...wood, kGearDegPerCm: 2.5, gearLaunchDegPerCm: 0.7, faceMaxDeg: 4.2, faceUpCm: 1.8, faceDownCm: 1.8, kVertRpmPerCm: 300, kVertLaunchPerCm: 0.6, kVertSpeed: 0.007, zoneCoef: 0.80, sweepMs: 1200, carryPgaM: 230 * YD },
    HY: { id: "HY", ballSpeed: 146 * MPH, launchDeg: 10.2, spinRpm: 4437, spinLoftDeg: 19, ...wood, kPath: 0.18, kGearDegPerCm: 1.8, gearLaunchDegPerCm: 0.6, gearSpeedK: 0.015, pathErrMaxDeg: 2.8, faceMaxDeg: 4.0, faceUpCm: 1.9, faceDownCm: 1.8, kVertRpmPerCm: 250, kVertLaunchPerCm: 0.5, kVertSpeed: 0.007, zoneCoef: 0.83, sweepMs: 1230, carryPgaM: 225 * YD },
    "3I": { id: "3I", ballSpeed: 142 * MPH, launchDeg: 10.4, spinRpm: 4630, spinLoftDeg: 20, ...iron, faceMaxDeg: 3.8, faceUpCm: 2.1, faceDownCm: 1.9, kVertRpmPerCm: 160, zoneCoef: 0.80, sweepMs: 1240, carryPgaM: 212 * YD },
    "4I": { id: "4I", ballSpeed: 137 * MPH, launchDeg: 11.0, spinRpm: 4836, spinLoftDeg: 21, ...iron, faceMaxDeg: 3.7, faceUpCm: 2.1, faceDownCm: 1.9, kVertRpmPerCm: 160, zoneCoef: 0.83, sweepMs: 1260, carryPgaM: 203 * YD },
    "5I": { id: "5I", ballSpeed: 59.0, launchDeg: 12.1, spinRpm: 5361, spinLoftDeg: 22, ...iron, faceMaxDeg: 3.5, faceUpCm: 2.2, faceDownCm: 1.9, kVertRpmPerCm: 150, zoneCoef: 0.86, sweepMs: 1280, carryPgaM: 194 * YD },
    "6I": { id: "6I", ballSpeed: 127 * MPH, launchDeg: 14.1, spinRpm: 6231, spinLoftDeg: 24, ...iron, faceMaxDeg: 3.5, faceUpCm: 2.2, faceDownCm: 1.85, kVertRpmPerCm: 150, zoneCoef: 0.93, sweepMs: 1280, carryPgaM: 183 * YD },
    "7I": { id: "7I", ballSpeed: 53.6, launchDeg: 16.3, spinRpm: 7097, spinLoftDeg: 26, ...iron, faceMaxDeg: 3.5, faceUpCm: 2.2, faceDownCm: 1.8, kVertRpmPerCm: 150, zoneCoef: 1.00, sweepMs: 1280, carryPgaM: 172 * YD },
    "8I": { id: "8I", ballSpeed: 115 * MPH, launchDeg: 18.1, spinRpm: 7998, spinLoftDeg: 28, ...iron, faceMaxDeg: 3.2, faceUpCm: 2.25, faceDownCm: 1.75, kVertRpmPerCm: 140, zoneCoef: 1.05, sweepMs: 1320, carryPgaM: 160 * YD },
    "9I": { id: "9I", ballSpeed: 48.7, launchDeg: 20.4, spinRpm: 8647, spinLoftDeg: 30, ...iron, faceMaxDeg: 3.0, faceUpCm: 2.3, faceDownCm: 1.7, kVertRpmPerCm: 130, zoneCoef: 1.10, sweepMs: 1350, carryPgaM: 148 * YD },
    PW: { id: "PW", ballSpeed: 45.6, launchDeg: 24.2, spinRpm: 9304, spinLoftDeg: 33, ...iron, kPath: 0.25, faceMaxDeg: 3.0, faceUpCm: 2.4, faceDownCm: 1.6, kVertRpmPerCm: 120, zoneCoef: 1.16, sweepMs: 1350, carryPgaM: 136 * YD },
    // SW 는 트랙맨 표에 없다 — 56° 풀샷 통상값(추정)
    SW: { id: "SW", ballSpeed: 40.0, launchDeg: 29.0, spinRpm: 10500, spinLoftDeg: 38, ...iron, kPath: 0.25, pathErrMaxDeg: 2.0, faceMaxDeg: 2.5, faceUpCm: 2.6, faceDownCm: 1.5, kVertRpmPerCm: 100, zoneCoef: 1.20, sweepMs: 1420, carryPgaM: 97 },
    PT: { id: "PT", ballSpeed: 6.0, launchDeg: 0, spinRpm: 0, spinLoftDeg: 4, kPath: 0, kGearDegPerCm: 0, gearLaunchDegPerCm: 0, gearSpeedK: 0, faceMaxDeg: 1.2, pathErrMaxDeg: 0, faceUpCm: 1.5, faceDownCm: 1.5, kVertRpmPerCm: 0, kVertLaunchPerCm: 0, kVertSpeed: 0, zoneCoef: 1.50, sweepMs: 1650, iron: false, carryPgaM: 0 },
};
