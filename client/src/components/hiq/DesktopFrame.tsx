...
/* ────────────────────────────────────────────────────────────────────────────
   ...
   **지금 앱에 있는 기능만** 적는다: 랭큐 매치(같이 쓰는 스코어카드·내기 정산), 조인·부킹, 골프 패스포트,
    ...
    return (
        ...
        >
            ...
            <p className="mt-4 text-[14px] leading-[1.7] text-ink-2 break-keep">
                홀마다 타수만 누르세요. 합계와 내기 정산은 랭큐가 맞춥니다. 긴급티·조인으로 빈자리를 채우고, 크루와 함께 기록을 쌓아요.
            </p>
...
function GolfSideRight() {
    return (
        ...
        >
            ...
            <p className="mt-auto pt-6 text-[11.5px] leading-[1.7] text-ink-4">
                타수는 홀마다 터치로 올리세요. 합계와 내기 정산은 랭큐가 셉니다.
            </p>
        </aside>
    );
}
...
const GOLF_FEATURES: { name: string; desc: string; icon: ReactNode; soon?: boolean }[] = [
    {
        name: "랭큐 매치",
        desc: "동반자와 한 스코어카드를 같이 씁니다. 타수가 실시간으로 맞춰지고 내기 정산도 자동이에요.",
