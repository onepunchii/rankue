...
export function InfoModal({ type, open, onOpenChange, sport = "BILLIARDS" }: InfoModalProps) {
        ...
        <div className="space-y-3">
            <div className="rk-card p-4 rounded-tile">
                <div className="flex items-center gap-2 mb-2">
                    <span className={cn("px-2 py-0.5 rounded text-[12px] font-semibold text-brand-fg", themeBg)}>공지</span>
                    <span className="text-[12px] text-black/55 font-mono">2026.02.01</span>
                </div>
                <h3 className="font-semibold text-sm text-ink-1 mb-1">랭큐(Rankue) 정식 서비스 런칭</h3>
            ...
            <div className="rk-card p-4 rounded-tile">
                <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-0.5 rounded text-[12px] font-semibold bg-blue-500 text-white">업데이트</span>
                    <span className="text-[12px] text-black/55 font-mono">2026.01.25</span>
                </div>
                <h3 className="font-semibold text-sm text-ink-1 mb-1">골프 모드 및 크루 기능 업데이트</h3>
                <p className="text-xs text-black/55 leading-relaxed">
    ...
    const guideContent = isGolf ? (
        <div className="space-y-4">
            <div className="flex gap-4">
                ...
                <div className="pb-6">
                    <h3 className="font-bold text-ink-1 text-sm">라운딩 및 스코어 기록</h3>
            ...
            <div className="flex gap-4">
                ...
                <div className="pb-6">
                    <h3 className="font-bold text-ink-1 text-sm">핸디캡 관리</h3>
                    <p className="text-xs text-black/55 mt-1 leading-relaxed">
            ...
            <div className="flex gap-4">
                ...
                <div>
                    <h3 className="font-bold text-ink-1 text-sm">회원권 거래소</h3>
                    <p className="text-xs text-black/55 mt-1 leading-relaxed">
        ...
        <div className="space-y-4">
            <div className="flex gap-4">
                ...
                <div className="pb-6">
                    <h3 className="font-bold text-ink-1 text-sm">매장 방문 및 체크인</h3>
                    <p className="text-xs text-black/55 mt-1 leading-relaxed">
            ...
            <div className="flex gap-4">
                ...
                <div>
                    <h3 className="font-bold text-ink-1 text-sm">게임 기록 및 분석</h3>
                    <p className="text-xs text-black/55 mt-1 leading-relaxed">
    ...
    const rankingContent = isGolf ? (
        <div className="space-y-4">
            <div className="rk-card p-4 rounded-tile">
                <h3 className="font-bold text-ink-1 text-sm mb-3">티어 시스템 (Tier)</h3>
                <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                        <span className="text-[#5b6b78] font-bold flex items-center gap-1">💎 PLATINUM</span>
                        <span className="text-black/55">핸디캡 0 ~ 5</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        ...
                        <span className="text-black/55">핸디캡 6 ~ 12</span>
                    </div>
                    <div className="w-full h-1 bg-black/[0.06] rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        ...
                        <span className="text-black/55">핸디캡 13 ~ 18</span>
                    </div>
                    <div className="w-full h-1 bg-black/[0.06] rounded-full overflow-hidden">
        ...
        <div className="space-y-4">
            <div className="rk-card p-4 rounded-tile">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                        <span className="text-[#5b6b78] font-bold flex items-center gap-1">💎 PLATINUM</span>
                        <span className="text-black/55">상위 10%</span>
                    </div>
                    <div className="w-full h-1 bg-black/[0.06] rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        <span className="text-[#cba258] font-bold flex items-center gap-1">🥇 GOLD</span>
                        <span className="text-black/55">상위 30%</span>
                    </div>
                    <div className="w-full h-1 bg-black/[0.06] rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        <span className="text-[#8a9299] font-bold flex items-center gap-1">🥈 SILVER</span>
                        <span className="text-black/55">상위 60%</span>
                    </div>
                    <div className="w-full h-1 bg-black/[0.06] rounded-full overflow-hidden">
