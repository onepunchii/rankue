...
export function InfoModal({ type, open, onOpenChange, sport = "BILLIARDS" }: InfoModalProps) {
        ...
        <div className="space-y-3">
            <div className="rk-card p-4 rounded-tile">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[12px] text-white/55 font-mono">2026.02.01</span>
                </div>
                <h3 className="font-semibold text-sm text-white mb-1">랭큐(Rankue) 정식 서비스 런칭</h3>
            ...
            <div className="rk-card p-4 rounded-tile">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[12px] text-white/55 font-mono">2026.01.25</span>
                </div>
                <h3 className="font-semibold text-sm text-white mb-1">골프 모드 및 크루 기능 업데이트</h3>
                <p className="text-xs text-white/55 leading-relaxed">
            ...
            <div className="rk-card p-4 rounded-tile">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="text-white/55">핸디캡 0 ~ 5</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        ...
                        <span className="text-white/55">핸디캡 6 ~ 12</span>
                    </div>
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        ...
                        <span className="text-white/55">핸디캡 13 ~ 18</span>
                    </div>
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
        ...
        <div className="space-y-4">
            <div className="rk-card p-4 rounded-tile">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                        <span className="text-[#e5e4e2] font-bold flex items-center gap-1">💎 PLATINUM</span>
                        <span className="text-white/55">상위 10%</span>
                    </div>
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        <span className="text-[#ffd700] font-bold flex items-center gap-1">🥇 GOLD</span>
                        <span className="text-white/55">상위 30%</span>
                    </div>
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                    ...
                    <div className="flex items-center justify-between text-xs mt-2">
                        <span className="text-[#c0c0c0] font-bold flex items-center gap-1">🥈 SILVER</span>
                        <span className="text-white/55">상위 60%</span>
                    </div>
                    <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-[#141416] border-white/10 text-white rounded-card w-[90%] max-w-sm p-6 gap-0">
