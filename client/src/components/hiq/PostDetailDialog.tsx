                            ...
                            <div className="space-y-6">
                                {comments.map((comment) => (
                                    <div key={comment.id} className="flex gap-4 group/comment">
                                        <div className="w-8 h-8 rounded-full bg-white/5 overflow-hidden border border-white/5 flex-shrink-0 transition-transform group-hover/comment:scale-105">
                                        ...
                                        <div className="flex-1 space-y-1.5">
                                            ...
                                            <p className="text-[13px] text-white/60 leading-relaxed font-medium">{comment.content}</p>
                                        </div>
