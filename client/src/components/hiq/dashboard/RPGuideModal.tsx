...
export function RPGuideModal({ open, onOpenChange }: RPGuideModalProps) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-[#1a1a1a] border-[#333] text-white rounded-card w-[90%] max-w-sm p-6 gap-0">
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        className="w-full py-4 rounded-xl bg-brand text-black font-bold text-sm hover:bg-[#059669] transition-colors"
                    >
                        알겠습니다
                    </button>
                </div>
